...
export const TPSPlayer = ({
  ...
  const cameraOffset = new Vector3(0, 1, 5); // Vector representing the offset of the camera from the player's position.
  ...
  return (
      ...
      >
        <mesh ref={meshR} userData={{tag: "player"}} castShadow>
          {children||( <sphereGeometry args={[1, 16, 16]}></sphereGeometry>)}

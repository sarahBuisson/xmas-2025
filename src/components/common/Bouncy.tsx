...
const Float = /* @__PURE__ */React.forwardRef(({
    ...
    useFrame(state => {
     //   var _floatingRange$, _floatingRange$2;
        ...
        ref.current.scale.x = Math.cos(t / 4 * speed) / 8 * bounceIntensity;
        ref.current.scale.y = Math.sin(t / 4 * speed) / 8 * bounceIntensity;
        ref.current.scale.z = Math.sin(t / 4 * speed) / 20 * bounceIntensity;
